                ...
                <Container style={container}>
                    <Section style={coverSection}>
                        ...
                        <Section style={upperSection}>
                            <Heading style={h1}>
                                {t('emails.account-deletion-email.heading')}
                            </Heading>
                            <Text style={mainText}>
                                {t('emails.account-deletion-email.message1')}
                            </Text>
                            <Text style={secondaryText}>
                                {t('emails.account-deletion-email.message2')}
                            </Text>
                            <Text style={secondaryText}>
                                {t('emails.account-deletion-email.message3')}
                            </Text>
                        </Section>
                        <Hr />
                    ...
                    <Text style={footerText}>
                        {t('emails.account-deletion-email.footer')}
                    </Text>
                </Container>
            </Body>
        </Html>
