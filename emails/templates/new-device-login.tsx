				...
				<Container style={container}>
					<Section style={coverSection}>
						...
						<Section style={upperSection}>
							<Heading style={h1}>{t('emails.new-device-login-email.heading')}</Heading>
							<Text style={mainText}>
							...
							<Text style={secondaryText}>{t('emails.new-device-login-email.message2')}</Text>
						...
						<Section style={lowerSection}>
							<Text style={cautionText}>{t('emails.new-device-login-email.securityTip')}</Text>
						</Section>
					</Section>
