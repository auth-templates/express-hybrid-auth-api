                ...
                <Container style={container}>
                    <Section style={coverSection}>
                        ...
                        <Section style={upperSection}>
                            <Heading style={h1}>
                                {t('emails.account-details-updated-email.heading')}
                            </Heading>
                            <Text style={mainText}>
                            ...
                            <Text style={secondaryText}>
                                {t('emails.account-details-updated-email.message2')}
                            </Text>
                            <Text style={secondaryText}>
                                {t('emails.account-details-updated-email.message3')}
                            </Text>
                            <Text style={secondaryText}>
                        ...
                        <Section style={lowerSection}>
                            <Text style={cautionText}>
                                {t('emails.account-details-updated-email.securityTip')}
                            </Text>
                        </Section>
                    </Section>
