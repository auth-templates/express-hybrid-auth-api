...
export default function InactiveAccountReminderEmail({ assetsUrl, t, frontendUrl }: InactiveAccountReminderEmailProps) {
	return (
		<Html>
			<Head />
			<Body style={main}>
				...
				<Container style={container}>
					<Section style={coverSection}>
						<Section style={imageSection}>
							<Img
								...
								width="75"
								height="45"
								alt={t('emails.inactive-account-reminder-email.logoAlt', {
									defaultValue: 'Company Logo',
								})}
							/>
						</Section>
						<Section style={upperSection}>
							<Heading style={h1}>{t('emails.inactive-account-reminder-email.heading')}</Heading>
							<Text style={mainText}>{t('emails.inactive-account-reminder-email.message1')}</Text>
							<Text style={secondaryText}>{t('emails.inactive-account-reminder-email.message2')}</Text>
					...
					<Text style={footerText}>{t('emails.inactive-account-reminder-email.footer')}</Text>
				</Container>
			</Body>
		</Html>
	);
