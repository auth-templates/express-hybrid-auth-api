				...
				<Container style={container}>
					<Section style={coverSection}>
						...
						<Section style={upperSection}>
							<Heading style={h1}>{t('emails.password-reset-email.heading')}</Heading>
							<Text style={mainText}>
								{t('emails.password-reset-email.instruction', { expiresInMinutes })}
							</Text>
							<Text style={mainText}>{t('emails.password-reset-email.message1')}</Text>
							{resetUrl && (
							...
							<Text style={secondaryText}>{t('emails.password-reset-email.message2')}</Text>
						</Section>
						<Hr />
						<Section style={lowerSection}>
							<Text style={cautionText}>{t('emails.password-reset-email.securityTip')}</Text>
						</Section>
					</Section>
