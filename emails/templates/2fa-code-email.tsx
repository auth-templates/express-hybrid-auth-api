				...
				<Container style={container}>
					<Section style={coverSection}>
						...
						<Section style={upperSection}>
							<Heading style={h1}>{t('emails.2fa-code-email.heading')}</Heading>
							<Text style={mainText}>{t('emails.2fa-code-email.instruction', { expiresInMinutes })}</Text>
							<Section style={verificationSection}>
								<Text style={verifyText}>{t('emails.2fa-code-email.label')}</Text>
								<Text style={codeText}>{verificationCode}</Text>
							</Section>
							<Text style={secondaryText}>{t('emails.2fa-code-email.ignore')}</Text>
						</Section>
						<Hr />
						<Section style={lowerSection}>
							<Text style={cautionText}>{t('emails.2fa-code-email.securityWarning')}</Text>
						</Section>
					</Section>
