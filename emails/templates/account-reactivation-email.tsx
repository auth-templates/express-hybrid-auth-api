...
export default function AccountReactivationEmail({ assetsUrl, frontendUrl, t }: AccountReactivationEmailProps) {
	return (
		<Html>
			<Head />
			<Body style={main}>
				...
				<Container style={container}>
					<Section style={coverSection}>
						...
						<Section style={upperSection}>
							<Heading style={h1}>{t('emails.account-reactivation-email.heading')}</Heading>
							<Text style={mainText}>{t('emails.account-reactivation-email.message1')}</Text>
							<Text style={secondaryText}>{t('emails.account-reactivation-email.message2')}</Text>
							<Section style={ctaSection}>
								<Link href={`${frontendUrl}/reactivate`} target="_blank" style={ctaButton}>
						...
						<Section style={lowerSection}>
							<Text style={cautionText}>
								...
								<Link href={`${frontendUrl}/contact-us`} target="_blank" style={link}>
					...
					<Text style={footerText}>{t('emails.account-reactivation-email.footer')}</Text>
				</Container>
			</Body>
		</Html>
	);
