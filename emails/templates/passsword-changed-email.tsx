...
export default function PasswordChangedEmail({ assetsUrl, frontendUrl, userEmail, t }: PasswordChangedEmailProps) {
	return (
		<Html>
			<Head />
			<Body style={main}>
				...
				<Container style={container}>
					<Section style={coverSection}>
						...
						<Section style={upperSection}>
							<Heading style={h1}>{t('emails.password-changed-email.heading')}</Heading>
							<Text style={mainText}>
								{t('emails.password-changed-email.message1', { email: userEmail })}
							</Text>
							<Text style={secondaryText}>{t('emails.password-changed-email.message2')}</Text>
						...
						<Section style={lowerSection}>
							<Text style={cautionText}>{t('emails.password-changed-email.securityTip')}</Text>
						</Section>
					</Section>
