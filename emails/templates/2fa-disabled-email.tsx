				...
				<Container style={container}>
					<Section style={coverSection}>
						...
						<Section style={upperSection}>
							...
							<Text style={mainText}>{t('emails.2fa-disabled.body')}</Text>
							<Text style={secondaryText}>{t('emails.2fa-disabled.recommendation')}</Text>
						</Section>
						<Hr />
						<Section style={lowerSection}>
							<Text style={cautionText}>{t('emails.2fa-disabled.warning')}</Text>
						</Section>
					</Section>
