                ...
                <Container style={container}>
                    <Section style={coverSection}>
                        ...
                        <Section style={upperSection}>
                            <Heading style={h1}>
                                {t('emails.email-address-changed-email.heading')}
                            </Heading>
                            <Text style={mainText}>
                            ...
                            <Text style={secondaryText}>
                                {t('emails.email-address-changed-email.message2')}
                            </Text>
                            <Text style={secondaryText}>
                            ...
                            <Text style={secondaryText}>
                                {t('emails.email-address-changed-email.message3')}
                            </Text>
                        </Section>
                        <Hr />
                        <Section style={lowerSection}>
                            <Text style={cautionText}>
                                {t('emails.email-address-changed-email.caution')}
                            </Text>
                        </Section>
                    </Section>
